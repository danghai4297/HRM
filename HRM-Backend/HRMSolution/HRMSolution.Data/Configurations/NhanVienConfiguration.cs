...
namespace HRMSolution.Data.Configurations
{
    public class NhanVienConfiguration : IEntityTypeConfiguration<NhanVien>
    {
        ...
        public void Configure(EntityTypeBuilder<NhanVien> builder)
        {
            ...
            //builder.Property(x => x.ngaySinh).HasColumnType("Date").HasDefaultValueSql("GetDate()").IsRequired();
            ...
            builder.Property(x => x.ngayCapHoChieu).HasColumnType("Date").HasDefaultValueSql("GetDate()");
            builder.Property(x => x.ngayHetHanHoChieu).HasColumnType("Date").HasDefaultValueSql("GetDate()");
            builder.Property(x => x.cccd).HasMaxLength(15).IsRequired();
            builder.Property(x => x.noiCapCCCD).HasMaxLength(25).IsRequired();
            //builder.Property(x => x.ngayCapCCCD).HasColumnType("Date").HasDefaultValueSql("GetDate()").IsRequired();
            //builder.Property(x => x.ngayHetHanCCCD).HasColumnType("Date").HasDefaultValueSql("GetDate()").IsRequired();
            ...
            builder.Property(x => x.tamTru).HasMaxLength(150).IsRequired();
            builder.Property(x => x.ngheNghiep).HasMaxLength(50).IsRequired();
            builder.Property(x => x.chucVuHienTai).HasMaxLength(50).IsRequired();
            builder.Property(x => x.ngayTuyenDung).HasColumnType("Date").HasDefaultValueSql("GetDate()");
            builder.Property(x => x.ngayThuViec).HasColumnType("Date").HasDefaultValueSql("GetDate()");
            builder.Property(x => x.congViecChinh).HasMaxLength(50).IsRequired();
            builder.Property(x => x.ngayVaoBan).HasColumnType("Date").HasDefaultValueSql("GetDate()");
            //builder.Property(x => x.ngayChinhThuc).HasColumnType("Date").HasDefaultValueSql("GetDate()").IsRequired();
            builder.Property(x => x.coQuanTuyenDung).HasMaxLength(50).IsRequired();
            builder.Property(x => x.ngachCongChucNoiDung).HasMaxLength(50);
            builder.Property(x => x.ngayVaoDang).HasDefaultValueSql("getdate()");
            builder.Property(x => x.ngayVaoDangChinhThuc).HasColumnType("Date").HasDefaultValueSql("GetDate()");
            builder.Property(x => x.ngayNhapNgu).HasColumnType("Date").HasDefaultValueSql("GetDate()");
            builder.Property(x => x.ngayXuatNgu).HasColumnType("Date").HasDefaultValueSql("GetDate()");
            builder.Property(x => x.quanHamCaoNhat).HasMaxLength(50);
            builder.Property(x => x.danhHieuCaoNhat).HasMaxLength(50);
            builder.Property(x => x.ngayVaoDoan).HasColumnType("Date").HasDefaultValueSql("GetDate()");
            ...
            builder.Property(x => x.ngayNghiViec).HasColumnType("Date").HasDefaultValueSql("GetDate()");
