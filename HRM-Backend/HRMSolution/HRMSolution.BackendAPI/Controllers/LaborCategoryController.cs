...
namespace HRMSolution.BackendAPI.Controllers
{
    ...
    {
        private readonly ILaborCategoryService _danhMucTinhChatLaoDongService;
        public LaborCategoryController(ILaborCategoryService danhMucTinhChatLaoDongService)
        {
