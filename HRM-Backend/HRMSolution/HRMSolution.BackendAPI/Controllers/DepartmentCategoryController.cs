...
namespace HRMSolution.BackendAPI.Controllers
{
    ...
    {
        private readonly IDepartmentCategoryService _danhMucPhongBanService;
        public DepartmentCategoryController(IDepartmentCategoryService danhMucPhongBanService)
        {
