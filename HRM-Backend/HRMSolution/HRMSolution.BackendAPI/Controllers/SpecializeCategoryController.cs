...
namespace HRMSolution.BackendAPI.Controllers
{
    ...
    {
        private readonly ISpecializeCategoryService _danhMucChuyenMonService;
        public SpecializeCategoryController(ISpecializeCategoryService danhMucChuyenMonService)
        {
