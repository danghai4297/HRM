...
{
    public class TypeOfContractCategoryService : ITypeOfContractCategoryService
    {
        private readonly HRMDbContext _context;
        public TypeOfContractCategoryService(HRMDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<int> Update(int id, DanhMucLoaiHopDongUpdateRequest request)
        {
            ...
            else
            {
                ...
                danhMucLoaiHopDong.tenLoaiHopDong = tenDanhMuc;
                var result = await _context.SaveChangesAsync();
                if (result == 0)
                    return 0;
                else
