            ...
            else
            {
                ...
                if (queryHopDong == null)
                {
                    var hopDong = new HopDong()
                    {
                        ...
                        ghiChu = checkNull(request.ghiChu),
                        trangThai = true,
        ...
        public async Task<HopDongViewModel> GetHopDong(string maHopDong)
        {
            ...
            else
            {
                ...
                var data = await query.Select(x => new HopDongViewModel()
                {
                    ...
                    hopDongTuNgay = DateTime.SpecifyKind(x.p.hopDongTuNgay, DateTimeKind.Utc),
                    hopDongDenNgay = DateTime.SpecifyKind(x.p.hopDongDenNgay, DateTimeKind.Utc),
                    ghiChu = x.p.ghiChu,
