    ...
    public class EmployeeService : IEmployeeService
    {
        ...
        public async Task<int> Create(NhanVienCreateRequest request)
        {
            ...
            else
            {
                ...
                var nhanVien = new NhanVien()
                {
                    ...
                    ngayCapHoChieu = request.ngayCapHoChieu == "null" || request.ngayCapHoChieu == null ? dt : DateTime.Parse(request.ngayCapHoChieu.ToString()),
                    ngayHetHanHoChieu = request.ngayHetHanHoChieu == "null" || request.ngayHetHanHoChieu == null ? dt : DateTime.Parse(request.ngayHetHanHoChieu.ToString()),
                    ...
                    ngayTuyenDung = request.ngayTuyenDung == "null" || request.ngayTuyenDung == null ? dt : DateTime.Parse(request.ngayTuyenDung.ToString()),
                    ngayThuViec = request.ngayThuViec == "null" || request.ngayThuViec == null ? dt : DateTime.Parse(request.ngayThuViec.ToString()),
                    congViecChinh = checkNull(request.congViecChinh),
                    ngayVaoBan = request.ngayVaoBan == "null" || request.ngayVaoBan == null ? dt : DateTime.Parse(request.ngayVaoBan.ToString()),
                    ngayChinhThuc = request.ngayChinhThuc == "null" || request.ngayChinhThuc == null ? dt : DateTime.Parse(request.ngayChinhThuc.ToString()),
                    ...
                    ngayVaoDang = request.ngayVaoDang == "null" || request.ngayVaoDang == null ? dt : DateTime.Parse(request.ngayVaoDang.ToString()),
                    ngayVaoDangChinhThuc = request.ngayVaoDangChinhThuc == "null" || request.ngayVaoDangChinhThuc == null ? dt : DateTime.Parse(request.ngayVaoDangChinhThuc.ToString()),
                    quanNhan = request.quanNhan,
                    ngayNhapNgu = request.ngayNhapNgu == "null" || request.ngayNhapNgu == null ? dt : DateTime.Parse(request.ngayNhapNgu.ToString()),
                    ngayXuatNgu = request.ngayXuatNgu == "null" || request.ngayXuatNgu == null ? dt : DateTime.Parse(request.ngayXuatNgu.ToString()),
                    quanHamCaoNhat = checkNull(request.quanHamCaoNhat),
                    danhHieuCaoNhat = checkNull(request.danhHieuCaoNhat),
                    ngayVaoDoan = request.ngayVaoDoan == "null" || request.ngayVaoDoan == null ? dt : DateTime.Parse(request.ngayVaoDoan.ToString()),
                    ...
                    ngayNghiViec = request.ngayNghiViec == "null" || request.ngayNghiViec == null ? dt : DateTime.Parse(request.ngayNghiViec.ToString()),
        ...
        public async Task<int> Update(string id, NhanVienUpdateRequest request)
        {
            ...
            else
            {
                ...
                nhanVien.ngayCapHoChieu = request.ngayCapHoChieu == "null" || request.ngayCapHoChieu == null ? dt : DateTime.Parse(request.ngayCapHoChieu.ToString());
                nhanVien.ngayHetHanHoChieu = request.ngayHetHanHoChieu == "null" || request.ngayHetHanHoChieu == null ? dt : DateTime.Parse(request.ngayHetHanHoChieu.ToString());
                ...
                nhanVien.ngayTuyenDung = request.ngayTuyenDung == "null" || request.ngayTuyenDung == null ? dt : DateTime.Parse(request.ngayTuyenDung.ToString());
                nhanVien.ngayThuViec = request.ngayThuViec == "null" || request.ngayThuViec == null ? dt : DateTime.Parse(request.ngayThuViec.ToString()); ;
                ...
                nhanVien.ngayVaoDangChinhThuc = request.ngayVaoDangChinhThuc == "null" || request.ngayVaoDangChinhThuc == null ? dt : DateTime.Parse(request.ngayVaoDangChinhThuc.ToString());
                nhanVien.quanNhan = request.quanNhan;
                nhanVien.ngayNhapNgu = request.ngayNhapNgu == "null" || request.ngayNhapNgu == null ? dt : DateTime.Parse(request.ngayNhapNgu.ToString());
                nhanVien.ngayXuatNgu = request.ngayXuatNgu == "null" || request.ngayXuatNgu == null ? dt : DateTime.Parse(request.ngayXuatNgu.ToString());
                nhanVien.quanHamCaoNhat = checkNull(request.quanHamCaoNhat);
                nhanVien.danhHieuCaoNhat = checkNull(request.danhHieuCaoNhat);
                nhanVien.ngayVaoDoan = request.ngayVaoDoan == "null" || request.ngayVaoDoan == null ? dt : DateTime.Parse(request.ngayVaoDoan.ToString());
                ...
                nhanVien.ngayNghiViec = request.ngayNghiViec == "null" || request.ngayNghiViec == null ? dt : DateTime.Parse(request.ngayNghiViec.ToString());
