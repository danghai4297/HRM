...
const schema = yup.object({
    ...
    idHinhThucDaoTao: yup.string().required("Hình thức đào tạo không được bỏ trống."),
    idTrinhDo: yup.string().required("Trình độ không được bỏ trống."),
  ...
  return (
    ...
    <div className="container-form">
      <div className="Submit-button sticky-top">
        <div>
          <h2 className="">{dataDetailTDVH.length !== 0 ? "Sửa" : "Thêm"} trình độ</h2>
        </div>
      ...
      >
        ...
        <div className="container-div-form">
          ...
          <div className="row">
            ...
            <div className="col">
              <div className="form-group form-inline">
                <label class="col-sm-4 justify-content-start" htmlFor="idChuyenMon">
                 Chuyên môn
                </label>
                <select
                  type="text"
          ...
          <div className="row">
            <div className="col">
              <div class="form-group form-inline ">
                <label class="col-sm-4 justify-content-start" htmlFor="tenTruong">
                  Tên trường
                </label>
                <input
                  type="text"
            ...
            <div className="col">
              <div className="form-group form-inline">
                ...
                <span className="message">{errors.idHinhThucDaoTao?.message}</span>
              </div>
            </div>
          </div>
          <div className="row">
