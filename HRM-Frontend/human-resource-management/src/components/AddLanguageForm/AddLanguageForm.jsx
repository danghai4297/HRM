...
function AddLanguageForm(props) {
    ...
    <div className="container-form">
      <div className="Submit-button sticky-top">
        <div>
          <h2 className="">{dataDetailNN.length !== 0 ? "Sửa" : "Thêm"} ngoại ngữ</h2>
        </div>
      ...
      >
        ...
        <div className="container-div-form">
          ...
          <div className="row">
            <div className="col">
              <div class="form-group form-inline ">
                <label class="col-sm-4 justify-content-start" htmlFor="idDanhMucNgoaiNgu">
                  Ngoại ngữ
                </label>
                <select
                  type="text"
                ...
                >
                    <option value={dataDetailNN.idDanhMucNgoaiNgu}>{dataDetailNN.tenChuyenMon}</option>
                  {dataNN.map((item,key)=>(
                ...
                <span className="message">{errors.idDanhMucNgoaiNgu?.message}</span>
              </div>
            </div>
            <div className="col">
